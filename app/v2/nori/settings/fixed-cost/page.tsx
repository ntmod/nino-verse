      ...
      <div className="max-w-2xl w-full space-y-8">
        <header className="flex items-center justify-between mb-12">
          <div className="flex items-center gap-4">
            <button 
              onClick={handleBack}
              className="w-10 h-10 rounded-xl bg-white flex items-center justify-center hover:bg-white transition-colors cursor-pointer"
            >
              <ArrowLeft className="w-5 h-5 text-[#777777]" />
            </button>
            <div>
              <h1 className="text-2xl font-black text-[#000000] italic tracking-tighter uppercase">Fixed Costs</h1>
              <p className="text-xs font-bold text-[#777777] uppercase tracking-widest">Manage your recurring subscriptions</p>
            </div>
          </div>
          <button 
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-6">
                    <div 
                      className="w-14 h-14 rounded-xl flex items-center justify-center text-2xl bg-white"
                    >
                      🧾
                    </div>
                    <div>
                      <h3 className="text-base font-black text-[#000000] italic uppercase">{cost.name}</h3>
                      <p className="text-[10px] font-black text-[#777777] uppercase tracking-widest mt-0.5">{cost.category || "No Category"} • {cost.paymentMethod || "No Method"}</p>
                ...
                <div className="flex items-center gap-2">
                  <button 
                    ...
                    className="w-10 h-10 rounded-xl bg-white flex items-center justify-center hover:bg-white transition-all group/btn cursor-pointer"
                  >
                    <Pencil className="w-4 h-4 text-[#777777] group-hover/btn:text-[#FF9D00]" />
                  </button>
                  <button 
                    onClick={() => handleDeleteFixedCost(cost._id)}
                    className="w-10 h-10 rounded-xl bg-white flex items-center justify-center hover:bg-rose-50 transition-all group/btn cursor-pointer"
                  >
              ...
              <div className="p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-[#777777] uppercase tracking-widest ml-1">Bill Name</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-[#777777] uppercase tracking-widest ml-1">Monthly Amount</label>
                    <input
                      type="number"
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-[#777777] uppercase tracking-widest ml-1">Category</label>
                    <div className="relative">
                      <select
                        value={newCost.category}
                        onChange={(e) => setNewCost({ ...newCost, category: e.target.value })}
                        className="w-full px-6 py-4 rounded-xl bg-slate-50/70 focus:outline-none focus:ring-2 focus:ring-[#FF9D00]/20 focus:bg-white transition-all text-sm font-bold text-[#000000] appearance-none cursor-pointer"
                      >
                      ...
                      <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#777777] pointer-events-none" />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-[#777777] uppercase tracking-widest ml-1">Payment Method</label>
                    <div className="relative">
                      <select
                ...
                <div className="grid grid-cols-2 gap-4 mt-10">
                  <button
                    ...
                    className="py-4 rounded-xl bg-slate-50/70 text-xs font-black text-[#777777] uppercase tracking-widest hover:bg-white transition-all cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
