      ...
      <div className="w-full max-w-4xl flex flex-col space-y-6">
        ...
        <div className="flex items-center justify-between">
          <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }}>
            <Link href="/v2/nori" className="flex items-center gap-1.5 text-gray-400 hover:text-black transition-colors mb-2 text-[10px] font-bold uppercase tracking-widest">
