...
const SETTINGS_OPTIONS = [
  { 
    ...
    path: "/v1/nori/settings/category", 
    icon: Tags,
    color: "#FF9D00"
  },
  { 
  ...
  { 
    ...
    path: "/v1/nori/settings/fixed-cost", 
    icon: CalendarClock,
    color: "#f43f5e"
  },
  { 
    ...
    path: "/v1/nori/settings/daily-average", 
    icon: Calculator,
    color: "#a855f7"
  },
];
